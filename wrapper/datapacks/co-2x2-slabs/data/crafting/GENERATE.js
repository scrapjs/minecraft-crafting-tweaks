...
//stairs.forEach((obj)=>{
    ...
    //fs.writeFileSync(`recipes/stairs/${obj.mc_version}/${obj.input}.json`, template(obj), 'utf8');
//});

slabs.forEach((obj)=>{
    fs.mkdirSync(`recipes/${obj.mc_version}`, { recursive: true });
    fs.writeFileSync(`recipes/${obj.mc_version}/${obj.input}.json`, template(obj), 'utf8');
});
